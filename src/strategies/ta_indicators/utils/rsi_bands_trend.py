...
from src.strategies.ta_indicators.utils.ta_tools import bands_cross_trend, create_strategy_df


def rsi_bands_trend(df: DataFrame, rsi_len: int = 14, upper_band: int = 70, down_band: int = 30) -> DataFrame:
    ...
    entry_long_series, entry_short_series = bands_cross_trend(df, rsi_upper_band_name, rsi_lower_band_name, rsi_series_name)
