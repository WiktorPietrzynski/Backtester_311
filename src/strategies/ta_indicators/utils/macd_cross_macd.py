...
def macd_cross_macd(df: DataFrame, fast_macd: int = 12, slow_macd: int = 26, macd_signal: int = 9) -> DataFrame:
    ...
    entries_long1, entries_short1 = simple_cross_value(df.loc[:, 'macd'], 0)
